...
namespace Player
{
    ...
    {
        public static Video ResolveLink(string rawLink)
        {
            ...
            /*if (jo.Value<string>("_type") == "url") // we are dealing with a playlist
                return new Video(jo["id"].ToString(), jo["title"].ToString());
            else */
            return Video.FromJson(line); // a single video
        }
        ...
        public class Video
        {
            ...
            public Video(string id, int seconds, string title = null)
            {
                Id = id;
                Seconds = seconds;
                Title = title;
            ...
            public static Video FromJson(string json)
            {
                ...
                var vid = new Video(jo["id"].ToString(), (int)jo["duration"], jo["title"].ToString())
                {
